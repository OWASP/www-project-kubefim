...
OWASP KubeFIM is a Linux file integrity and process-execution monitor for
Kubernetes. It attaches eBPF programs to syscall tracepoints on each node and
reports the operation, result, process identity, container runtime identity,
and Kubernetes workload metadata as JSON Lines.
